def insert_into_all(item, nested_list):
    ...
    for lst in nested_list:
        sub_new_list = lst.copy()
        sub_new_list.insert(0, item)
...
def subseqs(s):
    ...
    if not s:
        ...
        subsubseqs = subseqs(s[1:])
        return subsubseqs + insert_into_all(s[0], subsubseqs)
...
def num_trees(n):
    ...
    *   *        *       *
    ...
    # if n == 1:
    #     return 1
    # return sum(num_trees(j) * num_trees(n - j) for j in range(n - 1))
    dp = [0] * (n + 1)
    dp[1] = 1
